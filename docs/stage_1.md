...
Stage 1 replaces the `VoyagerSingleAgent-v0` placeholder with a real Gymnasium environment. The environment is a deterministic, single-agent, Crafter-style island survival prototype.
